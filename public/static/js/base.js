(function (global) {
    ...
    if (app_config.WEB_URL === 'http://www.chwl.loc/') {
        localStorage.setItem('wxInfo', '{"id":3,"openid":"oJStm6KLrGFTf9ybQzgpbkcvtjbk","nickname":"9526🔥","sex":1,"language":"zh_CN","city":"成都","province":"四川","country":"中国","headimgurl":"http://thirdwx.qlogo.cn/mmopen/vi_32/55VfXtu7EOT8bheElohGRicicA8IIz1jEHu4AmLgsib9vO8U1AdDibR7tgE3tRlrwiaJawPNEZmWRI31nHdrIrp2oxQ/132","role":1,"qr_code":null,"status":0,"salt":"5bfcb588ccdae","inviter":0,"created_at":"2018-11-09 18:46:50","updated_at":"2018-11-27 11:10:00","access_token":"16_-3JwD5okICzxv7VYj3s7RQ6tco7WtA5LuJWSIn1qGtL2yHill6q6O8KmxJKXH93cA0hbRdtMl5iwELJ-f47yiw","token":"063e66b2490c1761228177ede3673ad5c87d3bf9847122c7a44f83a98577fee7"}');
    }
...
// 用户点击了分享后执行的回调函数
                    ...
                    //     title: shareData.title, // 分享标题
                    //     link: app_config.WEB_URL, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
                    //     imgUrl: shareData.imgUrl, // 分享图标
                    //     success: function () {
                    //         // 设置成功
                    //     }
