...
<div id="userApp">
    ...
    <div class="user_top">
        ...
        <div class="ut2">
            ...
            <a href="{{url('user')}}?type=ewm" :class="{'active':type=='ewm'}">
                <i class="iconfont icon-erweima" style="line-height: 1.5;"></i><br>
                我的二维码
            </a>
        </div>
        <div class="ut3" v-if="type!='ewm'">
        如有预约或售后问题，请添加咨询联联周边游客服微信：dflgz094或dflgz155
        </div>
...
<div class="nav-b clearfix">
    <a class="{{Request::path()=='/'?'active':''}}" href="{{url('/')}}"><i class="fa fa-tachometer"></i><br>吃喝玩乐go</a>
    <a class="{{Request::path()=='business'?'active':''}}" href="{{url('/business')}}"><i class="fa fa-globe"></i><br>联盟商城</a>
    <a class="{{Request::path()=='user'?'active':''}}" href="{{url('/user')}}"><i class="fa fa-user"></i><br>我的</a>
</div>
