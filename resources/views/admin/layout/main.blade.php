	          ...
	          <div class="layui-side-scroll layui-bg-black">
	              <ul class="layui-nav layui-nav-tree" lay-filter="test">
	                  ...
	                  <li class="layui-nav-item" :class="open==2?'layui-nav-itemed':''">                      
	                     ...
	                     <dl class="layui-nav-child">
	                     	<dd>
	                           <a href="/web_admin/productList" :class="now_id==8?'layui-this':''" @click="memu_this(8)">产品管理</a>
	                        </dd>
	                        <dd>
	                           <a href="/web_admin/teamSet" :class="now_id==9?'layui-this':''" @click="memu_this(9)">组建团队设置</a>
	                        </dd>
	                        <dd>
	                           <a href="/web_admin/inviteSet" :class="now_id==10?'layui-this':''" @click="memu_this(10)">邀请关注奖励设置</a>
	                        </dd>                         
	                        <dd>
	                           <a href="/web_admin/inviteList" :class="now_id==11?'layui-this':''" @click="memu_this(11)">邀请关注列表</a>
	                        </dd>
	                     </dl>
	                  </li>
	                  <li class="layui-nav-item"  :class="open==3?'layui-nav-itemed':''">                      
	                     ...
	                     <dl class="layui-nav-child">
                           <dd>
                              <a href="/web_admin/businessList" :class="now_id==12?'layui-this':''" @click="memu_this(12)">商家管理</a>
                           </dd>                         
	                     </dl>
	                  </li>
	              </ul>
