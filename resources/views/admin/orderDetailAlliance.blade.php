...
<div class="layui-body layui-tab-content site-demo-body">
	<div class="info_box" id="order_detail_alliance">
		...
		<p class="pl30 mg20 clearfix" style="width: 70%">
			...
			<span class="layui-col-md3 mg20 t16"><span class="col-b">所在地区：&nbsp;</span> @{{alliance_info.area_value.length==0?'':alliance_info.area_value.name}}</span>
